...
negativeFolder='pic_Neg';  %path of negative samples for traffic sign detector
...
TrainingData_folder='D:\Final_Training\Images_png'; %Folder path of training data set
